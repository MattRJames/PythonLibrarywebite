...
class Book:
    ...
    def publisher(self, publisher: Publisher):
        if isinstance(publisher, Publisher):
            if isinstance(self.__publisher, Publisher):
                self.__publisher.books.remove(self)
    ...
    def get_related_books(self):
        return self.__related_books

    def set_related_books(self,id_list):
        for id in id_list:
            self.__related_books.append(int(id))
...
class Review:
    ...
    def __eq__(self, other):
        ...
        return other.book == self.book and other.user == self.user \
...
class User:
    ...
    def add_favorite(self, book):
        if isinstance(book, Book):
            self.__favorites.append(book)

    def remove_favorite(self, book):
        if book in self.__favorites:
            self.__favorites.remove(book)
